...
for thisBlock in blocks:
    ...
    learning_trials = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(testFile, selection='randchoice(48, 14)'),
    ...
    for thisLearning_trial in learning_trials:
        ...
        if currentLoop.name == "learning_trials":
            print("VP %s TEST-TRIAL %d"%(expInfo['participant'], learning_trials.thisN+1))
    ...
    trials = data.TrialHandler(nReps=None, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(posFile, selection='randchoice(287, 10)'),
