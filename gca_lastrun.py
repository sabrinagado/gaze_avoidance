...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/sabrinagado/Documents/Forschung/Promotion/Projects/GCA/gca_lastrun.py',
...
image = visual.ImageStim(
    win=win,
    name='image', 
    image='stimuli/social/016_y_m_n_b.jpg', mask=None, anchor='center',
    ori=0.0, pos=(-0.5, 0.2), size=None,
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    # *image* updates
    if image.status == NOT_STARTED and tThisFlip >= 6-frameTolerance:
        # keep track of start time/frame for later
