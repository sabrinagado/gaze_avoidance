...
expName = 'gca_discrimination2'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'group': ['A', 'B', 'C', 'D'],
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\sag22id\\Documents\\Projects\\GCA\\gca_avoidance\\Study 2\\Experiment\\gaze_discrimination_task2\\gca_discrimination2_lastrun.py',
...
textStartTask = visual.TextStim(win=win, name='textStartTask',
    ...
    font='Open Sans',
    pos=(0, 0.75), height=0.06, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-1.0);
textTaskImages = visual.TextStim(win=win, name='textTaskImages',
    text='Diese Bilder werden präsentiert:',
    font='Open Sans',
    pos=(0, 0.55), height=0.06, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-2.0);
ImageTask1 = visual.ImageStim(
    ...
    ori=0.0, pos=(-0.45, 0.25), size=(0.221875, 0.416667),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-3.0)
ImageTask2 = visual.ImageStim(
    ...
    ori=0.0, pos=(-0.15, 0.25), size=(0.221875, 0.416667),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-4.0)
ImageTask3 = visual.ImageStim(
    win=win,
    name='ImageTask3', 
    image='stimuli/Social3.png', mask=None, anchor='center',
    ori=0.0, pos=(0.15, 0.25), size=(0.221875, 0.416667),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
ImageTask4 = visual.ImageStim(
    win=win,
    name='ImageTask4', 
    image='stimuli/Social4.png', mask=None, anchor='center',
    ori=0.0, pos=(0.45, 0.25), size=(0.221875, 0.416667),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-6.0)
ImageTask5 = visual.ImageStim(
    win=win,
    name='ImageTask5', 
    image='stimuli/Nonsocial1.png', mask=None, anchor='center',
    ori=0.0, pos=(-0.45, -0.20), size=(0.221875, 0.416667),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-7.0)
ImageTask6 = visual.ImageStim(
    win=win,
    name='ImageTask6', 
    image='stimuli/Nonsocial2.png', mask=None, anchor='center',
    ori=0.0, pos=(-0.15, -0.20), size=(0.221875, 0.416667),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-8.0)
ImageTask7 = visual.ImageStim(
    win=win,
    name='ImageTask7', 
    image='stimuli/Nonsocial3.png', mask=None, anchor='center',
    ori=0.0, pos=(0.15, -0.20), size=(0.221875, 0.416667),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=-9.0)
ImageTask8 = visual.ImageStim(
    win=win,
    name='ImageTask8', 
    image='stimuli/Nonsocial4.png', mask=None, anchor='center',
    ori=0.0, pos=(0.45, -0.20), size=(0.221875, 0.416667),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
textTaskSpace = visual.TextStim(win=win, name='textTaskSpace',
    ...
    font='Open Sans',
    pos=(0, -0.7), height=0.06, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-11.0);
...
for thisBlock in blocks:
    ...
    learning_trials = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(testFile, selection=randchoice(48, 10)),
    ...
    for thisLearning_trial in learning_trials:
        ...
        if currentLoop.name == "learning_trials":
            print("VP %s PRACTICE-TRIAL %d"%(expInfo['participant'], learning_trials.thisN+1))
        
        if currentLoop.name == "trials":
            print("VP %s TRIAL %d"%(expInfo['participant'], trials.thisN+1))
        # keep track of which components have finished
        ...
        firstImage.setImage(eval(stim1))
        # keep track of which components have finished
        ...
        secondImage.setImage(eval(stim2))
        # keep track of which components have finished
    ...
    # keep track of which components have finished
    startTaskComponents = [textStartTask, textTaskImages, ImageTask1, ImageTask2, ImageTask3, ImageTask4, ImageTask5, ImageTask6, ImageTask7, ImageTask8, textTaskSpace, spaceStartTask]
    ...
    while continueRoutine:
        ...
        # *ImageTask5* updates
        if ImageTask5.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            ImageTask5.frameNStart = frameN  # exact frame index
            ImageTask5.tStart = t  # local t and not account for scr refresh
            ImageTask5.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(ImageTask5, 'tStartRefresh')  # time at next scr refresh
            ImageTask5.setAutoDraw(True)
        
        # *ImageTask6* updates
        if ImageTask6.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            ImageTask6.frameNStart = frameN  # exact frame index
            ImageTask6.tStart = t  # local t and not account for scr refresh
            ImageTask6.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(ImageTask6, 'tStartRefresh')  # time at next scr refresh
            ImageTask6.setAutoDraw(True)
        
        # *ImageTask7* updates
        if ImageTask7.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            ImageTask7.frameNStart = frameN  # exact frame index
            ImageTask7.tStart = t  # local t and not account for scr refresh
            ImageTask7.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(ImageTask7, 'tStartRefresh')  # time at next scr refresh
            ImageTask7.setAutoDraw(True)
        
        # *ImageTask8* updates
        if ImageTask8.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            ImageTask8.frameNStart = frameN  # exact frame index
            ImageTask8.tStart = t  # local t and not account for scr refresh
            ImageTask8.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(ImageTask8, 'tStartRefresh')  # time at next scr refresh
            ImageTask8.setAutoDraw(True)
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(posFile, selection=np.concatenate((np.random.permutation(np.arange(0, 144))[0:24], np.random.permutation(np.arange(144, 288))[0:24], np.random.permutation(np.arange(288, 336))[0:24], np.random.permutation(np.arange(336, 384))[0:24]))),
